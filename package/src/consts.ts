...
export const namedRoutes = (name: string): Record<string, InjectedRoute> => {
	return {
		...
		'Portal: Projects Index': {
			pattern: `[...locale]${routeMap.portal.projects.index}`,
			entrypoint: `${name}/routes/portal/projects/index.astro`,
			prerender: false,
		},
		'Portal: New Project': {
			pattern: `[...locale]${routeMap.portal.projects.newProject}`,
			entrypoint: `${name}/routes/portal/projects/new.astro`,
			prerender: false,
		},
		// 'Portal: Edit Project': {},
		'Portal: View Project': {
			pattern: `[...locale]${routeMap.portal.projects.viewProject}`,
			entrypoint: `${name}/routes/portal/projects/[project]/index.astro`,
			prerender: false,
		},
